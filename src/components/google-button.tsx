...
export function GoogleButton() {
  return (
    <form action={loginWithGoogle}>
      <button
        type="submit"
        className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-border bg-surface py-3 text-sm font-medium text-text transition-colors hover:border-text-tertiary"
      >
